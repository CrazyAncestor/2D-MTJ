...
def plot_MR(data,bool_out_of_plane=False,LockingRatio=1.0e6,I_col=1,R_col=5,title='B-MR curve',plot_filename='B-MRcurve.png',style=['dot','line'],dot_size=10):
    I_data = data[:,I_col]
    R_data = data[:,R_col]
...
if __name__ == '__main__':
    ...
    figure_dir = 'data_figure'
    

    RTemp_filename = './ori_data/ACR_monitor_KA.txt'
    IV_filename = './ori_data/IV_(2023_03_21_21_24)NO.2_KA.txt'
    
    Inplane_MR_400G_filename1 = '.\ori_data\AC_Scan_KA_m400GTO400G_T10K_10MOhm_wt3s_tc1s.txt'
    Inplane_MR_400G_filename2 = '.\ori_data\AC_Scan_KA_400GTOm400G_T10K_10MOhm_wt3s_tc1s.txt'

    Inplane_MR_1T_filename1 = '.\combined_data\AC_Scan_KA_m1TO1T_T10K_10MOhm_wt3s_tc1s.txt'
    Inplane_MR_1T_filename2 = '.\combined_data\AC_Scan_KA_1TOm1T_T10K_10MOhm_wt3s_tc1s.txt'
    ...
    #   In-plane MR 1T
    Inplane_MR_1T_data1 = read_data(Inplane_MR_1T_filename1)
    plot_MR(Inplane_MR_1T_data1,title='In-plane MR 1T forward',plot_filename= figure_dir +'/'+ 'In-plane MR data 1T forward.png')

    Inplane_MR_1T_data2 = read_data(Inplane_MR_1T_filename2)
    plot_MR(Inplane_MR_1T_data2,title='In-plane MR 1T backward',plot_filename= figure_dir +'/'+ 'In-plane MR data 1T  backward.png')

    #   In-plane MR 400G
    Inplane_MR_400G_data_forward = read_data(Inplane_MR_400G_filename1)
    Inplane_MR_400G_data_backward = read_data(Inplane_MR_400G_filename2)

    plot_MR(Inplane_MR_400G_data_forward,title='In-plane MR 400G forward',plot_filename= figure_dir +'/'+ 'In-plane MR data 400G forward.png')
    plot_MR(Inplane_MR_400G_data_backward,title='In-plane MR 400G backward',plot_filename= figure_dir +'/'+ 'In-plane MR data 400G backward.png')
